...
export default function Gallery() {
    ...
    return (
        <div className="py-[3.5rem]">
            <h2 className="font-bebas text-[64px] text-white text-center mb-12">GALLERY</h2>
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1">
                ...
                <div className="bg-cover bg-no-repeat bg-center relative"
                    ...
                    <div className="relative z-10 p-8 lg:p-[4rem]">
                        <h3 className="font-bebas text-[32px] text-[#FFBD00]">
                            Tami Residence Conference Center, Nis
                        </h3>
                        <p className="text-white mb-4">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aut, debitis et mollitia nesciunt
                            numquam officiis placeat quidem soluta? Excepturi fugiat hic iure minima modi quos similique
                            vel. Assumenda beatae commodi consectetur delectus, dicta dignissimos dolorem facilis ipsum
                            iusto laborum obcaecati odio placeat possimus quae quam quibusdam quod sequi sint totam!
                        </p>
                    </div>
                </div>
            </div>
