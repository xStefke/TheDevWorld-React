export default function Newsletter() {
    return (
        <div className="p-18 flex flex-col items-center justify-center">
            <h2 className="font-bebas text-[48px] lg:text-[64px] text-white text-center">NEWSLETTER</h2>
            <h3 className="text-white text-center text-[18px] lg:text-[24px] font-semibold -mt-2">Stay in the loop
                - get
                updates!</h3>
