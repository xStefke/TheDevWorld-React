...
const linkClass = "text-gray-300 hover:text-white hover:border-b-amber-300 hover:border-b-1 px-4 py-2 transition-colors duration-200 font-medium";
export default function Navbar() {
    const [isOpen, setIsOpen] = useState(false);
    // isOpen = false → meni zatvoren na mobile
    // setIsOpen menja stanje klikom na hamburger
        ...
        <header className="absolute top-0 left-0 w-full z-20 bg-transparent">
            <nav className="max-w-7xl mx-auto flex items-center justify-between py-4 px-6">
                ...
                <div className="hidden lg:flex items-center space-x-6">
                    ...
                    <a href="#speakers" className={linkClass}>Speakers</a>
