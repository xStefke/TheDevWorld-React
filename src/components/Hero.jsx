...
export default function Hero() {
  return (
    ...
    >
      <div className="absolute top-0 left-0 w-full h-full bg-[#000000af] bg-gradient-to-b from-black/0 to-[#0b0016] z-[1]"></div>

      <div className="container flex flex-col z-[5] mx-auto max-w-7xl px-4">
        <h1 className="text-(--primary-color) text-[40px] sm:text-[50px] md:text-[64px]">
          THEDEVWORLD 2025
        </h1>

        <h3 className="text-[18px] sm:text-[24px] md:text-[32px] mt-3">
          Where the world’s top developers unite to build the future{" "}
